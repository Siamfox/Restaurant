...
ADD OBJECT btn18	AS CommandButton
...
btn15.tooltiptext="Compras, Ingreso Mercancia por Compras"
...
btn18.WIDTH = 35
btn18.Caption = ""
btn18.picture = SYS(5)+"\siamfox\bitmaps\clibord2.ico"
btn18.backcolor=RGB(193,193,215) 
btn18.tooltiptext="Comandas, Captura de Comandas"
...
PROCEDURE btn18.click
DO FORM frmcomandas
ENDPROC


PROCEDURE btn13.click
SALIR()			&& Activar/Desactivar(x) menuppal
ENDPROC
