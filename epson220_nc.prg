*********************************************************************************
**FUNCTION epson40 220 &&  IMPRIME LAS NOTAS DE CREDITO \ EN PRINTER FISCAL EPSON *
*********************************************************************************
...
m.cabecera=+;
'DEVOLUCION: '+STR(WNRO)+ CHR(13)+CHR(10)+;
...
fechdev=DTOC(DATE())
horadev=TIME()
*coob='00000' &&LEFT(ALLTRIM(coob), 38)+ CHR(13)+CHR(10)  
