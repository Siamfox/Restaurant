*********************************************************************************
**FUNCTION bemate  &&  IMPRIME LAS FACTURAS DETAL \ EN PRINTER FISCAL BEMATECH*
*********************************************************************************
...
**---------------------------------------------------------------
   IF C->DIR1<>SPACE(45)  &&MAXIMO 133
      ...
      IF LEN(CDIR)>133
         ...
         WAIT WINDOWS '­­­ AVISO !!! MAXIMO VALOR EN LONGITUD DIRECCION FISCAL ' &&nowait
      ENDIF
   ELSE
...
**---------------------------------------------------------------
**//Detalle Impresion Fiscal Bematech 32bits
**---------------------------------------------------------------
SELECT 11
GO TOP
