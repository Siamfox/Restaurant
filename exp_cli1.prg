...
**------------------------------------------------------------
m.sPathFileOpen=SYS(2003)+"\cliente_exp.xlsx"
...
SELECT nombre,id,rif,telefonos,dir1,dir2,ciudad,estado,email,web,activo ;
FROM FORCE cliente ORDER BY 1 ASC INTO CURSOR cliente_exp READWRITE
...
m.objExcel.Cells(m.nRow,2).Value=ALLTRIM(id)+ALLTRIM(rif)
