...
l=1
  ...
  texto='i'+wl+'Condiciones de Pago: '
  IF con_crd=2
...
*!*	      tex1= 'Cedula :'+ALLTRIM(wCEI_CLI)
  ENDIF 
  IF !EMPTY(tex1)
      tex1=SUBSTR(tex1+SPACE(35),1,35)
      *l=l+1
      *IF LEN(ALLTRIM(STR(l)))=1
      *   wl='0'+ALLTRIM(TRANSFORM(l,'99'))
      *ELSE
  ...
  *-------------------
  ...
  texto=texto+'P'+'H'+'91'+'       ... NOTA IMPORTANTE ...'+Chr(13) + Chr(10)
  texto=texto+'P'+'H'+'92'+'         Revise Su Mercancia'+Chr(13) + Chr(10)
  texto=texto+'P'+'H'+'93'+'.......GRACIAS  POR  SU COMPRA....'+Chr(13) + Chr(10)
  *------escribo datos--------
