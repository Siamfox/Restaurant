...
cFile = 'c:\exportados\exp_inventario.txt'

**--Todo el archivo
*SELECT * FROM inven ORDER BY 1 ASC INTO CURSOR expInv READWRITE

**--Seleccion de campos
SELECT linea,codigo,descrip,unidad,pre3 FROM force inven ORDER BY 1 ASC INTO CURSOR expInv READWRITE TO FILE exp_inventario.txt
